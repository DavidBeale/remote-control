(() => {
  ...
  function asWebComponent(func, renderer, { baseElement = void 0, baseClass = HTMLElement, effect = void 0 } = {}) {
      ...
      for await (const content of componentFunc(...Object.values(fields))) {
        ...
        if (privateProps.get(this).isFirstRender && effect) {
          ...
          for (const prop in privateProps.get(this).self) {
            if (typeof privateProps.get(this).self[prop] === "object" && "value" in privateProps.get(this).self[prop]) {
              effect(() => {
                const _4 = privateProps.get(this).self[prop]?.value;
                privateProps.get(this).self[$emit]();
              });
            }
          }
    ...
    exportWrapper.define(
      name,
      void 0,
      baseElement ? { extends: baseElement } : void 0
    );
  ...
  async function* WakeLock() {
    ...
    for await (const { wakeLockDisabled } of this) {
      yield /* @__PURE__ */ o4(k, { children: [
        ...
        !wakeLockDisabled.value && /* @__PURE__ */ o4("span", { children: "\u{1F6AB}" })
      ] });
    }
  }
  ...
  var package_default = {
    ...
    scripts: {
      ...
      build: "esbuild src/main.js --bundle --outdir=dist/dist --jsx-import-source=preact --jsx=automatic --target=safari16 --sourcemap && cp -r public/. dist/",
      lint: "eslint src",
  ...
  async function DeviceSelector(devices, currentDeviceName) {
    ...
    return /* @__PURE__ */ o4(k, { children: [
      /* @__PURE__ */ o4("link", { rel: "stylesheet", href: "/dist/main.css" }),
      /* @__PURE__ */ o4("nav", { children: [
        /* @__PURE__ */ o4("div", { role: "group", children: devices.map((name) => {
        ...
        /* @__PURE__ */ o4("select", { onChange: menuSelect, value: "", children: [
          /* @__PURE__ */ o4("option", { value: "", disabled: true, children: "..." }),
          /* @__PURE__ */ o4("option", { children: "Add Device" }),
          /* @__PURE__ */ o4("option", { children: "Disconnect" })
        ] })
      ] })
    ] });
  }
    ...
    for await (const { currentDeviceName, selectOpen } of this) {
      ...
      yield /* @__PURE__ */ o4(k, { children: [
        ...
        /* @__PURE__ */ o4("main", { class: "container-fluid", children: [
          ...
          service.isConnected.value ? /* @__PURE__ */ o4(Controls_default, { service }) : /* @__PURE__ */ o4(Connect_default, { service })
        ] })
      ] });
    }
  }
  var RemoteControl_default = asWebComponent(RemoteControl, D, { effect: b3 });
